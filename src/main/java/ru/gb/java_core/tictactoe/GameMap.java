package ru.gb.java_core.tictactoe;
...
public class GameMap extends JPanel {
    ...
    private static final int STATE_WIN_FIRST_PLAYER = 1;
    private static final int STATE_WIN_SECOND_PLAYER = 3;
    ...
    private void showGameOverMessage(Graphics g) {
        ...
        switch (stateGameOver) {
            ...
            case STATE_WIN_FIRST_PLAYER -> g.drawString("1st PLAYER WIN", getWidth() / 4, getHeight() / 2);
            case STATE_WIN_SECOND_PLAYER -> g.drawString("2nd PLAYER WIN", getWidth() / 4, getHeight() / 2);
